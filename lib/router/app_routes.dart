...
class AppRoutes {
  ...
  static final menuOptions = <MenuOption> [
    ...
    MenuOption(route: 'listview2', icon: Icons.list_outlined, name: 'Listview tipo 2', screen: const Listview2Screen()),
    MenuOption(route: 'alert', icon: Icons.add_alert, name: 'Alertas -Alerts', screen: const AlertScreen()),
